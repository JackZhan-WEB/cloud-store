package club.jackzhan.cloudstore.web.interceptor;

import club.jackzhan.cloudstore.util.PageBean;
import club.jackzhan.cloudstore.util.ReflectUtil;
...
public class PageInterceptor implements Interceptor {
    ...
    public Object intercept(Invocation invocation) throws Throwable {
        ...
        if (page != null) {
            ...
            // 给当前的page参数对象设置总记录数
            this.setTotalCount(page, (MapperMethod.ParamMap) params,
     ...
     * @return Mysql数据库分页语句
     */
    private String getSqlserverPageSql(PageBean<?> page, StringBuffer sqlBuffer) {
        // 计算第一条记录的位置，Sqlserver中记录的位置是从0开始的。
        int startRowNum = (page.getCurrentPage() - 1) * page.getPageSize() + 1;
     ...
     */
    private void setTotalCount(PageBean<?> page, MapperMethod.ParamMap params,
